...
const empty = { raw: 0, words: 0, images: 0, labeled: 0, excluded: 0, pending: 0, gold_done: 0, gold_in_progress: 0 }
...
describe("stepStates", () => {
  ...
  it("markiert vollständige Schritte als erledigt", () => {
    const s = stepStates({ raw: 40, words: 40, images: 40, labeled: 40, excluded: 0, pending: 0, gold_done: 0, gold_in_progress: 0 }, [])
  ...
  it("zählt aussortierte Duplikate als erledigt, nicht als Rückstand", () => {
    ...
    const s = stepStates(
      { raw: 327, words: 196, images: 196, labeled: 196, excluded: 131, pending: 0, gold_done: 0, gold_in_progress: 0 },
      [],
    )
    expect(s["02_extract_words"]).toBe("done")
  })
  ...
  it("hält teilweise gelabelte Seiten startbar statt erledigt", () => {
    const s = stepStates({ raw: 40, words: 40, images: 40, labeled: 37, excluded: 0, pending: 0, gold_done: 0, gold_in_progress: 0 }, [])
  ...
  it("bleibt bei nur einer Variante offen – der Vergleich fehlt noch", () => {
    const full = { raw: 40, words: 40, images: 40, labeled: 40, excluded: 0, pending: 0, gold_done: 0, gold_in_progress: 0 }
...
describe("stepProgress", () => {
  it("zeigt Anteile für die datenverarbeitenden Schritte", () => {
    const totals = { raw: 40, words: 40, images: 40, labeled: 37, excluded: 0, pending: 0, gold_done: 0, gold_in_progress: 0 }
  ...
  it("rechnet den Nenner gegen die Duplikate", () => {
    const totals = { raw: 327, words: 196, images: 196, labeled: 196, excluded: 131, pending: 0, gold_done: 0, gold_in_progress: 0 }
